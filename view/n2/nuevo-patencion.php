                        ...
                        <div class="container-fluid">
                            <div class="sb-page-header-content py-3">
                                 <ol class="breadcrumb mt-4 mb-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="listado_patencion.php">Listado- P Atención</a></li>
                    ...
                    <div class="container-fluid mt-n10">
                        <div class="card mb-4">
                            <div class="card-header">
                                Registrar nuevo Punto de Atención
                            </div>
                            <div class="card-body">
                                            ...
                                            <div class="col-xxl-6 col-xl-8">
                                                <form id="formulario1">
                                                    <div class="form-row">
                                                        ...
                                                        <div class="form-group col-md-3">
                                                            <label class="small mb-1" for="inputPrioridad"><strong>Prioridad</strong></label>
                                                    ...
                                                    <div class="d-flex justify-content-between">
                                                        <a class="btn btn-danger" href="listado_patencion.php">Atras</a>
