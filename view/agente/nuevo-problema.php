                        ...
                        <div class="container-fluid">
                            <div class="sb-page-header-content py-3">
                                 <ol class="breadcrumb mt-4 mb-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="listado_problema.php">Listado- Problema</a></li>
                                                ...
                                                <form id="formulario1">
                                                    <div class="form-row">
                                                        <div class="form-group col-md-6">
                                                            <label class="small mb-1" for="inputID"><strong>ID Problema</strong></label>
                                                            <input class="form-control" id="inputID" type="number" name="inputID" required placeholder="Ingrese ID Problema" />
                                                        </div>
                                                        <div class="form-group col-md-6">
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <label class="small mb-1" for="fecha"><strong>Fecha Creación</strong></label>
                                                                    <input type="text" class="form-control" name="fecha" id="fecha">
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <label class="small mb-1" for="hora"><strong>Hora Creación</strong></label>
                                                    ...
                                                    <div class="d-flex justify-content-between">
                                                        <a class="btn btn-danger" href="listado_problema">Atras</a>
