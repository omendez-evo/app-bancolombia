                        ...
                        <div class="container-fluid">
                            <div class="sb-page-header-content py-3">
                                 <ol class="breadcrumb mt-4 mb-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="listado_repotenciacion.php">Listado- Repotenciación</a></li>
                            ...
                            <div class="tab-pane fade show active" id="documentacion" role="tabpanel" aria-labelledby="overview-pill">
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                       <div class="row">
                                            <div class="col-md-8">
                                                <strong><h5 id="titulo"></h5></strong><br>
                                                <strong>Descripción:</strong><br><label id="descripcion"></label><br><br>
                                        ...
                                        <strong><label id="actividad_label" for="descripcion">Actividades</label><br></strong>
                                            <br>
                                            <br>
            ...
            <div class="modal-body">
                <form>
                    <div class="row">
                        ...
                        <div class="col-md-10">
                        <div class="form-group">
                            <label for="documentacion">Titulo</label>
...
<div class="modal fade" id="modal-avanceRepotenciacion" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Agregar nuevo detalle</h5>
                <button class="close" type="button" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            </div>
            <div class="modal-body">
                <form>
            ...
            <div class="modal-body">
                <form id="form-comment" style="display: none;">
                    <div class="row">
                        ...
                        <input type="text" name="id_repotenciacion" id="id_repotenciacion" hidden>
                        </div>
                        <div class="col-md-2">
                            <br>
                            <br>
...
function cargar_comentario(id){
    $.ajax({
        type: 'POST',
        data:{id:id},
        url: '../../controlador/controller_repotenciacion.php?opcion=13',
...
function edit_avances(id){
    ...
    $.ajax({
        type: 'POST',
        data:{id:id},
        url: '../../controlador/controller_repotenciacion.php?opcion=15',
        success:function(responseText){    
...
$("#selectAsignatarios").select2({
    /*ajax: {
        url: '../../controlador/controller_repotenciacion.php?opcion=19',
        dataType: 'json'
...
$("#btn-guarda-asignatario").click(function (){
    $.ajax({
        ...
        url: '../../controlador/controller_repotenciacion.php?opcion=18',
        success:function(responseText){    
            $('#resultado').html(responseText);  
        } 
    });
...
$("#selectAsignatarios").on("select2:unselect", function (e) { 
   $.ajax({
        ...
        url: "../../controlador/controller_repotenciacion.php?opcion=20",
        success:function(responseText){    
            $('#resultado').html(responseText);  
        } 
    });
...
$("#btn-guardar34").click(function (){
    if($("#documentacion3").val()!=""){
        $.ajax({
            type: 'POST',
            data:{documentacion:$("#documentacion3").val(),id_traza:$("#id_traza").val(),id_repotenciacion:$("#id_repotenciacion").val()},
            url: "../../controlador/controller_repotenciacion.php?opcion=14",
            success:function(responseText){    
                $('#resultado').html(responseText);  
...
$("#btn-delete").click(function (){
    $.ajax({
        ...
        url: "../../controlador/controller_repotenciacion.php?opcion=17",
        success:function(responseText){    
            $('#resultado').html(responseText);  
...
$("#btn-modificar").click(function (){
    if($("#documentacion4").val()!=""){
        $.ajax({
            ...
            url: "../../controlador/controller_repotenciacion.php?opcion=16",
            success:function(responseText){    
                $('#resultado').html(responseText);  
...
$("#btn-siguiente").click(function(event) {//boton usando para moverse entre repotenciaciones
    location.href='../../controlador/controller_repotenciacion.php?opcion=10';
}); 
$("#btn-atras").click(function(event) {//boton usando para moverse entre repotenciaciones
    location.href='../../controlador/controller_repotenciacion.php?opcion=11';
}); 
...
$("#selectPrioridad").change(function (){
    $.ajax({
        ...
        url: '../../controlador/controller_repotenciacion.php?opcion=5',
        success:function(responseText){    
            $('#resultado').html(responseText);  
        } 
    });
...
function estado_avances(id_repot, id_subRepo){
        var opc=$("#estadoNr"+id_subRepo).val();
        console.log(id_repot,id_subRepo,opc);
        $.ajax({
            type: 'POST',
            data:{id_repot:id_repot,id_subRepo:id_subRepo,opc:opc},
            url: '../../controlador/controller_repotenciacion.php?opcion=55',
            success:function(responseText){    
                $('#resultado').html(responseText);  
                cargarData(12);
