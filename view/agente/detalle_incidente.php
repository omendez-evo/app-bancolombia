                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <!-- Profile picture help block-->
                                                    ...
                                                    <div id="box-problem">
                                                        Problema <br>
                                                        <a class="small btn btn-outline-primary" id="btn-problema">
                                                          Habilitar
                                                        </a>
                                                    </div>
                                                </div>
            ...
            <form>
                <div class="row"> 
                    <div class="col-md-2"></div>
                     <div class="col-md-8">
                        <div class="row">
                            Indique Fecha y Hora de Cierre de Incidente
                            <div class="col-md-6">
                        ...
                        <div id="inputID" style="display: none;">
                            Indique ID de Problema<br>
                            <label class="small mb-1" for="ID_problema"><strong>ID</strong></label>
                            <input type="text" class="form-control" name="ID_problema" id="ID_problema">
                        </div>
                        <br>
                    </div>
                    <div class="col-md-2"></div>
...
$("#inputDescripcion").change(function (){
    $.ajax({
        ...
        url: '../../controlador/controller_incidente.php?opcion=5',
