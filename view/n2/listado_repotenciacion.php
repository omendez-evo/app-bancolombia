...
<body class="sb-nav-fixed sb-sidenav-toggled">
            ...
            <div id="layoutSidenav_content">
                <main>
                        ...
                        <div class="container-fluid">
                            <div class="sb-page-header-content py-3">
                                <ol class="breadcrumb mt-4 mb-0">
                                    ...
                                    <li class="breadcrumb-item active">Repotenciacion</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    <div class="container-fluid mt-n10">
                        <div class="card mb-4">
                            <div class="card-header d-flex justify-content-between align-items-center">Repotenciación
                                <div>
                                    <button class="btn btn-outline-success btn-icon" id="btn-export-patencion" type="button">
                                    <i class="fas fa-file-excel"></i>
                                    </button>
                                    
                                    <a class="btn btn-outline-purple btn-icon" type="button" href="historial_repotenciacion.php">
        ...
        <div id="small-agregar">
            <a class="open-small-agregar" href="nuevo-repotenciacion.php" style="color: white;">
...
$("#listado_pa").DataTable({
    ...
    ajax:{
        method:"POST",
        url: "../../controlador/controller_repotenciacion.php?opcion=3",
    },
    columns:[
        {data:"id"},
        {data:"titulo"},
