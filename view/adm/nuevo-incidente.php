                        ...
                        <div class="container-fluid">
                            <div class="sb-page-header-content py-3">
                                 <ol class="breadcrumb mt-4 mb-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="listado_incidentes.php">Listado- Incidente</a></li>
                                                ...
                                                <form id="formulario1">
                                                    <div class="form-row">
                                                        <div class="form-group col-md-6">
                                                            <label class="small mb-1" for="inputOC"><strong>ID Incidente</strong></label>
                                                            <input class="form-control" id="inputIncidente" type="number" name="inputIncidente" required placeholder="Ingrese ID Incidente" />
                                                        </div>
                                                        <div class="form-group col-md-6">
                                                    ...
                                                    <div class="d-flex justify-content-between">
                                                        <a class="btn btn-danger" href="listado_incidentes.php">Atras</a>
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-xxl-6 col-xl-8">
                                                <form id="formulario2">
                                                    <div class="form-row">
                                                        <div class="form-group col-md-12">
                                                            <label class="small mb-1" for="selectGrupo"><strong>Grupo</strong></label>
                                                            <select class="form-control" id="selectGrupo" name="selectGrupo"></select>
                                                        </div>
                                                        <div class="form-group col-md-10" style="display: none;">
                                                            <label class="small mb-1" for="inputOtro"><strong>Otra Grupo</strong></label>
                                                            <input class="form-control" id="inputOtro" name="inputOtro" type="text" placeholder="Ingrese Otro Grupo" />
                                                        </div>
                                                    </div>
                                                    <div class="form-row">
                                                        <div class="form-group col-md-6">
